...
- [ ] As a user, I can **add a new professor** to the system.
- [ ] As a user,  I can **view all professors**.
- [ ] As a user, I can **update a professor's** information.
- [ ] As a user, I can **remove a professor** who is no longer teaching.
- [ ] As a user, I can **create a new class** and assign it to a professor.
- [ ] As a user, I can **view all classes**, including the assigned professor.
- [ ] As a user, I can **update a class's** details (e.g., reassign to a different professor).
- [ ] As a user, I can **delete a class** from the system.
- [ ] As a user, I can **add a new student** to the system.
- [ ] As a user, I can **view all students**.
- [ ] As a user, I can **update a student's** information.
- [ ] As a user, I can **remove a student** from the system.
- [ ] As a user, I can **enroll a student in a class**.
- [ ] As a user, I can **drop a student from a class**.
- [ ] As a user, I can **view all students enrolled in a given class**.
- [ ] As a user, I can **view all classes a given student is enrolled in**.
- [ ] As a user, I can **generate a student enrollment report** (as HTML or Markdown) for a selected student, listing all classes they are enrolled in.
- [ ] As a user, I can **generate a professor summary report** (as HTML or Markdown) for a selected professor, listing all classes they are teaching and the students enrolled in each.
